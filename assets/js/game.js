...
var fight = function(enemy) {
  ...
  while (playerInfo.health > 0 && enemy.health > 0) {
    if (isPlayerTurn) {
      ...
      // remove enemy's health by subtracting the amount we set in damage
...
var endGame = function() {
  ...
  if (playerInfo.money > highScore) {
    ...
    alert(playerInfo.name + " did not beat the high score or " + highScore +". Maybe next time!");
  }
